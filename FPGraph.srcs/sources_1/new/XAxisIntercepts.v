...
module XAxisIntercepts(
    ...
    output reg           g1_Y1Sign,
    output reg [13:0]   g1_Y1Int, g1_Y1Dec,
    
    output reg           g1_X2Sign,
    output reg [13:0]   g1_X2Int, g1_X2Dec,
    
    output reg           g1_Y2Sign,
    output reg [13:0]   g1_Y2Int, g1_Y2Dec,
    ...
    output reg           g2_Y1Sign,
    output reg [13:0]   g2_Y1Int, g2_Y1Dec,
    
    output reg           g2_X2Sign,
    output reg [13:0]   g2_X2Int, g2_X2Dec,
    
    output reg           g2_Y2Sign,
    output reg [13:0]   g2_Y2Int, g2_Y2Dec,
    ...
    output reg           g3_Y1Sign,
    output reg [13:0]   g3_Y1Int, g3_Y1Dec,
    
    output reg           g3_X2Sign,
    output reg [13:0]   g3_X2Int, g3_X2Dec,
    
    output reg           g3_Y2Sign,
    output reg [13:0]   g3_Y2Int, g3_Y2Dec,
    
    output reg [1:0]    g3_isCalculated
    //----------------------------------------------------------
);
        ...
        if (startCalculate && !prevStartCalculate) begin
            ...
            case (state)
                ...
                1: if (temp_isCalculated == CALCULATED || temp_isCalculated == NO_SOLUTION) begin
                    ...
                    g1_isCalculated <= temp_isCalculated; // Indicate that the calculation is done
                    startIntersectionQuadratic <= 0; 
                    state <= 2;
                end
                ...
                3: if(temp_isCalculated == CALCULATED || temp_isCalculated == NO_SOLUTION) begin
                    ...
                    g2_isCalculated <= temp_isCalculated; // Indicate that the calculation is done
                    startIntersectionQuadratic <= 0; 
                    state <= 4;
                end
                ...
                5: if(temp_isCalculated == CALCULATED || temp_isCalculated == NO_SOLUTION) begin
                    ...
                    g3_isCalculated <= temp_isCalculated; // Indicate that the calculation is done
                    startIntersectionQuadratic <= 0; 
                    state <= 6;
                end
